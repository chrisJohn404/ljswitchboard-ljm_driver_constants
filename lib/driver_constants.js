...
exports.DEFAULT_LJ_LIB_LOCATION;
exports.DEFAULT_LJM_JSON_FILE_LOCATION;
exports.DEFAULT_K3_TEMPORARY_FILE_LOCATION;
if(process.platform === 'win32') {
	exports.DEFAULT_LJ_LIB_LOCATION = path.join(process.env.ALLUSERSPROFILE, 'LabJack');
	...
	exports.DEFAULT_LJ_LIB_LOCATION = path.join('usr','local','share', 'LabJack');
...
if(typeof(exports.cmpy_os_str) != 'string') {
	exports.cmpy_os_str = 'linux';
}
const os = exports.cmpy_os_str;
