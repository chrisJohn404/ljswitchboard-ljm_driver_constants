...
// Ethernet and WiFi UDP Scanning Port
exports.LJM_ETH_UDP_PORT = 52362;
exports.LJM_WIFI_UDP_PORT = 502;

// ===========================================================
// START: Define supported devices.
// ===========================================================
...
// ===========================================================
// END: Define supported devices.
// ===========================================================


// ===========================================================
// START: Define connection types.
// ===========================================================
//Connection Types
...
// ===========================================================
// END: Define connection types.
// ===========================================================

//==============================================
// START: Constants related to LJM types
//==============================================
var ljmTypeSizes = {
	UINT64: 8,
	INT32: 4,
...
if(typeof(exports.ARCH_POINTER_SIZE) != 'number') {
	throw new Error('ARCH_POINTER_SIZE undefined, ljswitchboard-ljm_driver_constants');
}
//==============================================
// END: Constants related to LJM types
//==============================================
...
// ============================== BEGIN CROSS PLATFORM AND ARCH CODE..... ================================
exports.compy_os_str = {
	'win': 'win',
	'win64': 'win',
	'win32': 'win',
	'mac': 'mac',
...
if(typeof(exports.compy_os_str) != 'string') {
	exports.compy_os_str = 'linux';
}
const os = exports.compy_os_str;
exports.os_str = {
	'windows': 'Windows',
	'mac': 'MacOS',
	'linux': 'Linux',
...
// Make accessable various windows variables
let SystemRoot;
let HOME_DRIVE;
let ALLUSERSPROFILE;
let PROGRAMFILES;
...
exports.LJM_LIBRARY_FILE_TYPE = {
	'linux': '.so',
	'mac': '.dylib',
	'win': '.dll',
}[os];
exports.LJM_LIBRARY_BASE_NAME = {
	'linux': 'libLabJackM',
	'mac': 'libLabJackM',
	'win': 'LabJackM',
}[os];
...
let defaultWindowsLibraryLocsToSearch = {
    'ia32': function() {return [
        path.join(process.env.SystemRoot, 'SysWOW64'), // 32-bit directory
        path.join(process.env.SystemRoot, 'System32') // 64-bit directory
    ];},
    'x64': function() {return [
    	path.join(process.env.SystemRoot, 'System32'), // 64-bit directory only
    ];},
};

exports.LJM_LIBRARY_SEARCH_PATHS;
exports.DEFAULT_LJM_LIBRARY_LOCATION; // The folder that the library is in.
exports.DEFAULT_LJM_LIBRARY_PATH; // The full path to the compiled file
let archQuery = {
	'ia32': 'ia32',
	'x64': 'x64'
}[process.arch];
if(typeof(archQuery) != 'string') {
	archQuery = 'def';
}

exports.LJM_LIBRARY_SEARCH_PATHS = {
	'linux': defaultLinuxLibraryLocsToSearch,
	'mac': defaultMacLibraryLocsToSearch,
	'win': defaultWindowsLibraryLocsToSearch,
}[os][archQuery]();

exports.DEFAULT_LJ_SHARE_LOCATION;
exports.DEFAULT_LJM_JSON_FILE_LOCATION;
exports.DEFAULT_K3_TEMPORARY_FILE_LOCATION;
exports.LJ_SHARE_SEARCH_LOCATIONS;
if(os === 'win') {
	exports.DEFAULT_LJ_SHARE_LOCATION = path.join(process.env.ALLUSERSPROFILE, 'LabJack');
	exports.DEFAULT_LJM_JSON_FILE_LOCATION = path.join(process.env.ALLUSERSPROFILE, 'LabJack', 'LJM', 'ljm_constants.json');
	exports.DEFAULT_K3_TEMPORARY_FILE_LOCATION = path.join(process.env.ALLUSERSPROFILE, 'LabJack', 'K3');
	exports.LJ_SHARE_SEARCH_LOCATIONS = [
		path.join(process.env.ALLUSERSPROFILE, 'LabJack'),
		'C:\\ProgramData\\LabJack',
        'C:\\Documents and Settings\\All Users\\Application Data\\LabJack',
	];
} else {
	exports.DEFAULT_LJ_SHARE_LOCATION = path.join('usr','local','share', 'LabJack');
	exports.DEFAULT_LJM_JSON_FILE_LOCATION = path.join('usr','local','share', 'LabJack', 'LJM', 'ljm_constants.json');
	exports.DEFAULT_K3_TEMPORARY_FILE_LOCATION = path.join('usr','local','share', 'LabJack', 'K3');
	exports.LJ_SHARE_SEARCH_LOCATIONS = [
		'/usr/local/share/LabJack'
	];
}

// Define absolute requirements to interface with the LJM library.
exports.ljn_requirements = {
	// This is LJM.
    'Driver': {
        'win32': {
            'ia32': [
    ...
    // This is where LabJack stores "user" data.
    'LabJack folder': {
        'win32': {
            'ia32': [
...
// Define optional requirements to interface with the LJM library.
exports.ljn_optional_requirements = {
    'LJM header file': {
        'win32': {
            'ia32': [
    ...
    // TODO: This file might be an absolute requirement, but
    // I think LJM has defined constants that it defaults to if this file
    // is not found.
...
exports.ljn_os_requirements = {};
exports.ljn_os_optional_requirements = {};
exports.ljn_core_requirements = {};

let ljn_requirement_keys = Object.keys(exports.ljn_requirements);
let ljn_optional_requirement_keys = Object.keys(exports.ljn_optional_requirements);

// Add valid requirements to the ljn_os_requirements object
ljn_requirement_keys.forEach(function(key) {
    // If the OS has that requirement
    if(exports.ljn_requirements[key][os]) {
        // If the OS/arch pair has a requirement
        if(exports.ljn_requirements[key][os][arch]) {
            exports.ljn_os_requirements[key] = exports.ljn_requirements[key][os][arch];
        }
    }
});

// Add valid optional requirements to the osOptionalRequirements object
ljn_optional_requirement_keys.forEach(function(key) {
    // If the OS has that requirement
    if(exports.ljn_optional_requirements[key][os]) {
        // If the OS/arch pair has a requirement
        if(exports.ljn_optional_requirements[key][os][arch]) {
            exports.ljn_os_optional_requirements[key] = exports.ljn_optional_requirements[key][os][arch];
        }
    }
});
...
core_keys.forEach(function(key) {
    // Switch on OS
    if(exports.ljn_requirements[key][os]) {
        // Switch on OS/Arch pair
        if(exports.ljn_requirements[key][os][arch]) {
            exports.ljn_core_requirements[key] = exports.ljn_requirements[key][os][arch];
        }
    }
});
...
/*
 * Constants used in high-level library.
 */
